...
var require_cluster_slots = __commonJS((exports) => {
  ...
  _a = RedisClusterSlots, _RedisClusterSlots_options = new WeakMap, _RedisClusterSlots_Client = new WeakMap, _RedisClusterSlots_emit = new WeakMap, _RedisClusterSlots_isOpen = new WeakMap, _RedisClusterSlots_runningRediscoverPromise = new WeakMap, _RedisClusterSlots_randomNodeIterator = new WeakMap, _RedisClusterSlots_instances = new WeakSet, _RedisClusterSlots_discoverWithRootNodes = async function _RedisClusterSlots_discoverWithRootNodes() {
    ...
    try {
      ...
      for (const [address, node4] of this.nodeByAddress.entries()) {
        if (addressesInUse.has(address))
          continue;
        if (node4.client) {
          promises.push(__classPrivateFieldGet(this, _RedisClusterSlots_instances, "m", _RedisClusterSlots_execOnNodeClient).call(this, node4.client, (client2) => client2.disconnect()));
        }
    ...
    const promise = __classPrivateFieldGet(this, _RedisClusterSlots_instances, "m", _RedisClusterSlots_createClient).call(this, node4).then((client2) => {
      node4.client = client2;
      return client2;
    }).catch((err) => {
  ...
  }, _RedisClusterSlots_execOnNodeClient = function _RedisClusterSlots_execOnNodeClient(client2, fn) {
    ...
    this.pubSubNode = {
      ...
      client: __classPrivateFieldGet(this, _RedisClusterSlots_instances, "m", _RedisClusterSlots_createClient).call(this, node4, true).then(async (client2) => {
        if (toResubscribe) {
          await Promise.all([
  ...
  class RedisCluster extends events_1.EventEmitter {
    ...
    MULTI(routing) {
      return new (__classPrivateFieldGet(this, _RedisCluster_Multi, "f"))((commands, firstKey, chainId) => {
        return __classPrivateFieldGet(this, _RedisCluster_instances, "m", _RedisCluster_execute).call(this, firstKey, false, (client2) => client2.multiExecutor(commands, undefined, chainId));
      }, routing);
    }
...
(async () => {
  try {
    ...
    console.log("Servidor HonoJS est\xE1 corriendo en el puerto 3000.");
  } catch (error) {
